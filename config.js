...
const CONFIG = {
    ...
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "Vill du vara min Alla-💞-dag dejt? 💝",
    ...
    questions: {
        ...
        third: {
            text: "Vill du vara min Alla-💞-dag dejt? Februari 14th, 2026? 🌹", // The big question!
            yesBtn: "Jaa!",                                             // Text for "Yes" button
            noBtn: "Nää"                                                 // Text for "No" button
        }
    },
    ...
    loveMessages: {
        extreme: "WOOOOW Sååå mycket?? 🥰🚀💝",  // Shows when they go past 5000%
        high: "IMPOSSIBRUU!!! 🚀💝",              // Shows when they go past 1000%
        normal: "Går de ens?! 🥰"                           // Shows when they go past 100%
    },

    // Messages that appear after they say "Yes!"
    celebration: {
        title: "Yay! Då blir jag återigen den lyckligaste på jorden! 🎉💝💖💝💓",
        message: "Men du är fortfarande en fis!",
